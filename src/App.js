...
const shellClass =
  "relative mx-auto flex min-h-screen w-full flex-col px-0 " +
  "md:px-6 lg:px-10";
...
const App = observer(() => {
  ...
  return (
    <div className="relative min-h-screen  font-sans text-[var(--color-text-primary)] selection:bg-[var(--color-accent-soft)] selection:text-[var(--color-accent-deep)]">
      <div
