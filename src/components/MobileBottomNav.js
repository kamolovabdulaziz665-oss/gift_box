...
const navShell =
  "fixed bottom-0 left-1/2 z-50 flex h-[72px] w-full -translate-x-1/2 items-stretch border-t border-[var(--color-border)] bg-white/90 px-2 pb-[max(16px,env(safe-area-inset-bottom))] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] shadow-[0_-8px_40px_rgba(15,23,42,0.08)] backdrop-blur-xl backdrop-saturate-150 md:hidden";
